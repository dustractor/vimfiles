...
;uncomment to find the number of your device---- InputBox n,, % List,,,,,,,, 1
...
R := DllCall(NumGet(NumGet(IPolicyConfig+0)+13*A_PtrSize), "UPtr", IPolicyConfig, "Str", Devices2[1], "UInt", 0, "UInt")
